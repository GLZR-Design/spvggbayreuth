...
<h3 data-aos="fade-up" class="has-headline-font-size has-white-color mb-md text-center is-uppercase has-text-shadow">Passend zum Thema</h3>
<?php if ( have_posts() ) : ?>
...
<?php else : ?>
<p class="has-white-color">Leider nichts gefunden.</p>
<?php endif; ?>
